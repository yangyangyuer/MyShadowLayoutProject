...
public class ShadowLayout extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        shadowRange =   typedArray.getDimension(R.styleable.ShadowLayout_shadowRange, dp2px(14));
        shadowRangeOffset =   typedArray.getDimension(R.styleable.ShadowLayout_shadowRangeOffset,dp2px(5));
        shadowColor = typedArray.getColor(R.styleable.ShadowLayout_shadowColor, Color.parseColor("#b9cccccc"));

        shadowOffsetLeft    =  typedArray.getDimension(R.styleable.ShadowLayout_shadowOffsetLeft, 0);

        shadowOffsetTop     =   typedArray.getDimension(R.styleable.ShadowLayout_shadowOffsetTop, 0);
        shadowOffsetRight   =  typedArray.getDimension(R.styleable.ShadowLayout_shadowOffsetRight, 0);
        shadowOffsetBottom  =  typedArray.getDimension(R.styleable.ShadowLayout_shadowOffsetBottom, 0);

        float shadowRadius =   typedArray.getDimension(R.styleable.ShadowLayout_shadowRadius, 0);
        shadowTopLeftRadius =   typedArray.getDimension(R.styleable.ShadowLayout_shadowTopLeftRadius, shadowRadius);
        shadowTopRightRadius =   typedArray.getDimension(R.styleable.ShadowLayout_shadowTopRightRadius, shadowRadius);
        shadowBottomRightRadius =   typedArray.getDimension(R.styleable.ShadowLayout_shadowBottomRightRadius, shadowRadius);
        shadowBottomLeftRadius =  typedArray.getDimension(R.styleable.ShadowLayout_shadowBottomLeftRadius, shadowRadius);
        solidColor = typedArray.getColor(R.styleable.ShadowLayout_solidColor,Color.WHITE);
